...
public class VmSprfmPermisos
{
    ...
    public string? SDetalleRevisor { get; set; }
    public string? SDetalleOtroGrupo { get; set; }
    public string? SDetalleUrAdicional { get; set; }
    public string? SDetallePermisoEspecifico { get; set; }
    public string? SDetallePermisoSimilar { get; set; }
}